<!-- mcp-name: CSOAI-ORG/gardening-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/gardening-ai-mcp.html)
...
```json
{
  "mcpServers": {
    "gardening-ai-mcp": {
      "command": "uvx",
      "args": ["gardening-ai-mcp"]
    }
  }
}
```

Or: `pip install gardening-ai-mcp` then run the `gardening-ai-mcp` command (stdio transport).

## Examples

Once configured, ask your assistant, for example:
- "Use `identify_plant` to …"
- "Use `generate_watering_schedule` to …"
- "Use `analyze_soil` to …"
